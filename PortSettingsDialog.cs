...
{  
    ...
    {      
        ...
        {    
            ...
            {
                UserInterfaceData?.Invoke("DisplayStatus", ComPorts.noComPortsMessage, Color.Red);
        ...
        private void PortSettingsDialog_Load_1(object sender, EventArgs e)
        {
        ...
        private void btnOK_Click(System.Object sender, System.EventArgs e)
        {
            ...
            if (ComPorts.comPortExists)
                UserInterfacePortSettings?.Invoke(cmbPort.SelectedItem.ToString(), System.Convert.ToInt32(cmbBitRate.SelectedItem), ((Handshake)(cmbHandshaking.SelectedItem)));

            UserInterfaceData?.Invoke(">>>DisplayPortSettings", "", Color.Black);

            if (cmbPort.SelectedIndex == -1) statusMessage = ComPorts.noComPortsMessage;
            else statusMessage = "";

            UserInterfaceData?.Invoke("DisplayStatus", statusMessage, Color.Black);
        }


        public string getSelectedPortName()
        {
            return System.Convert.ToString(cmbPort.SelectedItem);
        }

        public bool selectedPortChanged()
        {
